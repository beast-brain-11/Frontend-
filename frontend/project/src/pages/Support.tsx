...
const Support: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1A1C2E] text-slate-200 p-4 md:p-8"> {/* Added default text color and responsive padding */}
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Help & Support</h1> {/* Responsive title size */}
      ...
      <div className="bg-[#242842] rounded-xl p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4 mb-6"> {/* Responsive header */}
          <h2 className="text-xl font-semibold text-white">Frequently Asked Questions</h2>
          <div className="relative w-full sm:w-auto"> {/* Search input takes full width on small screens */}
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-[#1A1C2E] rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
            />
          </div>
        </div>
